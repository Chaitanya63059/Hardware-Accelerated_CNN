...
module cnn_pipeline_top #(
    ...
    // Forward declarations (must appear before use in read channel)
    ...
    always @(posedge aclk or negedge aresetn) begin
        if (!aresetn) begin
            ...
            if (aw_done && w_done) begin
                ...
                // Auto-clear write enables to generate a pulse
                if (slv_reg[8][0])  slv_reg[8]  <= 32'h0;
                if (slv_reg[11][0]) slv_reg[11] <= 32'h0;
            end
    ...
    // Write enables are now auto-cleared in the AXI write block
    wire w_wen_pulse = cfg_w_wen;
    wire b_wen_pulse = cfg_bias_wen;

    // ========================================================================
    // Status
    // ========================================================================
    // (compute_busy, compute_done, done_latched declared above)
